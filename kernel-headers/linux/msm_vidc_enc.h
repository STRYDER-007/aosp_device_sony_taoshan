...
#define VEN_IOCTL_SET_PIC_ORDER_CNT_TYPE _IOW(VEN_IOCTLBASE_ENC, 66, struct venc_ioctl_msg)
#define VEN_IOCTL_GET_PIC_ORDER_CNT_TYPE _IOR(VEN_IOCTLBASE_ENC, 67, struct venc_ioctl_msg)
struct venc_range {
/* WARNING: DO NOT EDIT, AUTO-GENERATED CODE - SEE TOP FOR INSTRUCTIONS */
  unsigned long max;
  unsigned long min;
